...
export default function MemeLook() {
  ...
  const memes = [
    ...
    { id: 2, name: "Dodge", rarity: "rare", img: "../src/assets/memeitems/DodgeDogpng.png", description: "Dog with sunglasses", chance:15 },
    ...
    { id: 7, name: "Boss Suit", rarity: "rare", img: "../src/assets/memeitems/BossDogpng.png", description: "Dog in a business suit", chance:15 },
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-400 font-pixelify">
      ...
      <div className="flex-1 w-full max-w-4x2 py-4 px-2 sm:py-8 sm:px-4 relative flex flex-col justify-center">
        ...
        <div className="absolute right-8 top-1/2 transform -translate-y-1/2">
            <img src="../src/assets/arrow/arrowtopage.png" onClick={() => navigate("/memeLook2")} alt="Next" className="w-16 h-16"/>
          </div>
