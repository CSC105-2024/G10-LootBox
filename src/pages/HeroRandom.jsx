...
export default function HeroRandom() {
  ...
  const heroes = [
    { id: 1, name: "Deadpool", rarity: "common", img: "../src/assets/heroitems/DeadPoolpng.png", description: "Stop talking bro" ,chance: 35 },
    { id: 2, name: "Conquest", rarity: "legendary", img: "../src/assets/heroitems/Conquestpng.png", description: "Where is mark" ,chance: 5 },
    { id: 3, name: "Home Lander", rarity: "legendary", img: "../src/assets/heroitems/HomeLanderpng.png", description: "I'm Homesick" ,chance: 3},
    { id: 4, name: "Atens", rarity: "rare", img: "../src/assets/heroitems/iShowSpeedpng.png", description: "I'm Steve" ,chance: 15},
    { id: 5, name: "Sinester Mark", rarity: "epic", img: "../src/assets/heroitems/SinesterMarkpng.png", description: "Oh oh.. poor Armstrong" ,chance: 8 },
    { id: 6, name: "Peace Maker", rarity: "epic", img: "../src/assets/heroitems/PeaceMakerpng.png", description: "Taralelo Tralala" ,chance: 8},
    { id: 7, name: "Rex Plode", rarity: "rare", img: "../src/assets/heroitems/RexPlodepng.png", description: "Boom!"  ,chance: 15},
    { id: 8, name: "Red Death", rarity: "epic", img: "../src/assets/heroitems/RedDeathpng.png", description: "I want to live" ,chance: 8 },
    { id: 9, name: "Omniman", rarity: "unreal", img: "../src/assets/heroitems/Omnimanpng.png", description: "Are you sure?" ,chance: 1.5},
    { id: 10, name: "YamCha", rarity: "unreal", img: "../src/assets/heroitems/YamChapng.png", description: "I hate Vegita",chance: 1.5 }
