...
export default function MemeRandom() {
  ...
  const memes = [
    { id: 1, name: "Cry Cat", rarity: "common", img: "../src/assets/memeitems/CryCatpng.png", description: "I'm crying rn", chance:13.33 },
    { id: 2, name: "Dodge", rarity: "rare", img: "../src/assets/memeitems/BossDogpng.png", description: "Dog with sunglasses", chance:15 },
    { id: 3, name: "Kirby with Knife", rarity: "rare", img: "../src/assets/memeitems/Kirbypng.png", description: "Pink Kirby holding a knife", chance:15 },
    { id: 4, name: "Spongebob", rarity: "epic", img: "../src/assets/memeitems/SpongeBobpng.png", description: "Distressed Spongebob", chance:7 },
    { id: 5, name: "Pepe Frog", rarity: "epic", img: "../src/assets/memeitems/PepeFrogpng.png", description: "Green frog character", chance:7 },
    { id: 6, name: "Nyan Cat", rarity: "common", img: "../src/assets/memeitems/NyanCatpng.png", description: "Cat with pop-tart body", chance:13.33 },
    { id: 7, name: "Boss Suit", rarity: "rare", img: "../src/assets/memeitems/DodgeDogpng.png", description: "Dog in a business suit", chance:15 },
    { id: 8, name: "Mike", rarity: "common", img: "../src/assets/memeitems/Mikepng.png", description: "Mike..", chance:13.33 },
    { id: 9, name: "Chamber", rarity: "legendary", img: "../src/assets/memeitems/Chamberpng.png", description: "HeadShot king!", chance:1},
    { id: 10, name: "Peter", rarity: "legendary", img: "../src/assets/memeitems/Peterpng.png", description: "Just Peter", chance:0.01},
  ];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-800 font-pixelify p-4">
      {!showResult ? (
        ...
        <div className="flex flex-col items-center justify-center w-full">
          ...
          >
            <img 
              src="../src/assets/chest/chest1.png" 
