...
const Main = () => {
  ...
  // Available songs
  const songs = [
    { title: "Phonk", src: "../src/assets/music/AmorNaPraia.mp3" },
    { title: "Serious Bacon", src: "../src/assets/music/wangwong.mp3" },
    { title: "Birds of feather", src: "../src/assets/music/BirdsOfFeather.mp3" },
    { title: "Pokemon Theme", src: "../src/assets/music/PokemonTheme.mp3" }
  ];
  ...
  return (
    <div 
      className="font-pixelify min-h-screen relative bg-[url('..\src\assets\background\superherobg.png')] bg-cover bg-center flex flex-col"
    >
        ...
        <div className="flex flex-1">
          ...
          <div className="w-1/3 flex flex-col items-center justify-center">
            <div className="mb-4 flex justify-center">
              ...
              >
                <img 
                  src={isChestButtonHovered ? '../src/assets/chest/chestOnhold.png' : '../src/assets/chest/Chest1.png'} 
                  alt="Hero Box" 
                  className="w-64"
                />
              </button>
            ...
            <div className="flex items-center justify-center mb-4">
              <div className="flex items-center justify-center">
                <img 
                  src="..\src\assets\key\key2.png"    //key
                  alt="Key"
                  className="h-5"
            ...
            <button 
                onClick={() => {  navigate("/HeroRandom");
                  if (keys > 0) {
                    ...
                    const openSound = new Audio('../src/assets/music/click.mp3');
              ...
              >
                <img 
                  src={isPlayButtonHovered ? '../src/assets/lbGadget/playbuttonCapicity35.png' : '../src/assets/lbGadget/playbutton.png'} 
                  alt="Play Button" 
                  className="w-48"
                />
              </button>
      ...
      <div className={isMobile 
       ...
       <button 
              ...
              >
                <img 
                  src={isChestButtonHovered ? '../src/assets/shop/shopbutton.png' : '../src/assets/shop/shopbutton.png'} 
                  alt="Sell button" 
                  className="w-20"
                />
              </button>
